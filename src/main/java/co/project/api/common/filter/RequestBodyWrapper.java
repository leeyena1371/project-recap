...
public class RequestBodyWrapper extends HttpServletRequestWrapper {
     ...
     */
    public RequestBodyWrapper(HttpServletRequest request) throws Exception {
        super(request);
        ...
        try {
            ...
            if (!request.getMethod().equals(RequestMethod.GET.name())) {
                ...
                body = new String(rawData, StandardCharsets.UTF_8);

                this.decodingBody = rawData;
            }
        } catch (Exception e) {
            log.error("[NO DECRYPT] - REQUEST INPUT STREAM READ FAIL.");
